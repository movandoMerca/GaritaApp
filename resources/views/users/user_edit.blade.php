    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card border custom-b">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('saveEdit.user') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <span class="switch switch-outline switch-icon switch-primary">
                                    <label>
                                        <input type="checkbox" name="admin" id="admin" @if ($user->is_admin)
                                            checked
                                                    @endif />
                                        <span></span>
                                    </label>
                        ...
                        <div class="form-group row">
                            <label for="admin"
                                class="col-md-4 col-form-label text-md-right">Usuario Activo</label>
                            <div class="col-md-6">
                                <span class="switch switch-outline switch-icon switch-primary">
                                    <label>
                                        <input type="checkbox"  name="active" id="active" @if ($user->status)
                                        checked
                                                @endif/>
                                        <span></span>
                                    </label>
