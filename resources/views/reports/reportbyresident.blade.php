...
<div class="card card-custom gutter-b border custom-b">
    <div class="card-header flex-wrap border-0 pt-6 pb-0 custom-bg ">
        <div class="card-title">
            <h2 class="card-label text-white">Reporte de Visitas por residente</h2>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered nowrap text-center" style="" id="visitreport_byresident">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Ingreso</th>
...
@section('scripts')
    <script src="{{ asset('js/visitreport_byresident.js') }}">
    </script>
@endsection