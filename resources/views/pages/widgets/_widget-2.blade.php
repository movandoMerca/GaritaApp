{{-- List Widget 9 --}}
    ...
    <?php  $visits = App\Models\Visit::whereDate('fechaingreso','=',date('Y-m-d'))->orderby('fechaingreso','desc')-> get();  ?>
...
<div class="card card-custom {{ @$class }}">
    ...
    <div class="row">
        ...
        <div class="text-center col-md-6"><label class="badge bg-secondary">Residente</label></div>
    </div>
    {{-- Body --}}
    <div class="card-body pt-4">
        <div class="scroll scroll-pull" data-scroll="true" data-wheel-propagation="true" style="max-height:350px;">
